@estudante
Feature: Compra de passagem com benefício estudante e compensação de carbono

  Como um usuário estudante autenticado do e-commerce
  Quero realizar a compra de uma passagem com benefício e compensação de carbono
  Para viajar de forma sustentável com desconto

  Scenario: Realizar compra de passagem com benefício estudante e compensação de carbono
