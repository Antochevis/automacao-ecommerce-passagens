@logado
Feature: Compra de passagem ida e volta logado com compensação de carbono
  ...
  Scenario: Realizar compra de passagem ida e volta logado com compensação de carbono
