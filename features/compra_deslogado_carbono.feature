Feature: Compra de passagem deslogado com compensação de carbono

  Como um usuário visitante do e-commerce
  Quero realizar a compra de uma passagem sem estar logado e com compensação de carbono
  Para viajar de forma sustentável

  Scenario: Realizar compra de passagem sem estar logado com compensação de carbono
