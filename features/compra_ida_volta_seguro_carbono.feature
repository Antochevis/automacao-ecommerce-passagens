Feature: Compra de passagem ida e volta deslogado com seguro e compensação de carbono
  ...
  Scenario: Realizar compra de passagem ida e volta deslogado com seguro e compensação de carbono
